...
vector<SBox>   gBox;
vector<SBox *>   gBoxp;
SWinLog             gWinLog[100][60000];
SNode *              gLogHead=new SNode;
string CWindow::sm_Time="2022022818000000";
...
void CWindow::loadTimes(int num)
{
    /************************
    * Input：  已有的消费次数
    *Output：修改窗口总消费次数
...
double CWindow::getMessage(int order)
{
    /************************
    * Input：  指令类型
    *Output：null
...
void CWindow::loadWinLog(string &log)
{
    /************************
    * Input：  消费记录
    *Output：将消费记录载入
