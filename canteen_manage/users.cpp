...
bool CCard::freezeCard(int order)
{
    /************************
    * Input：  指令
    *Output：写操作记录
...
bool CCard::reopenAccount(string newid)
{
    /************************
    * Input：  新的卡号
    *Output：写操作记录
...
string CCard::getMessage(int order)
{
    /************************
    * Input：  命令
    *Output：卡号
...
void CCard::chargeCard(double amount)
{
    /************************
    * Input：  充值金额
    *Output：修改余额，写入操作记录
...
void CCard::changePasswd(string newcode)
{
    /************************
    * Input：  新密码
    *Output：修改旧密码
...
bool CCard::verifyPasswd(string input)
{
    /************************
    * Input：  输入的密码
    *Output：null
...
int ManageCard(CCard &card,int order,int x=0,CCard * cards=nullptr)
{
    /************************
    * Input：  目标卡片
                    指令
